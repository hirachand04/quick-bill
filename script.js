...
class QuickBill {
    ...
    setupEventListeners() {
        ...
        // Make invoice number and date editable in preview
        document.getElementById('previewInvoiceNumber').addEventListener('input', (e) => {
            document.getElementById('invoiceNumber').value = e.target.textContent;
        });

        document.getElementById('previewDate').addEventListener('input', (e) => {
            const date = new Date(e.target.textContent);
    ...
    handleLogoUpload(event) {
        ...
        // Clear previews if no file is selected
        if (!file) {
            this.logoFile = null;
